...
\begin{flalign*}
    ...
    & \varphi_{2wordLetters}(u, a, b) \definedas \varphi_2(u) \Land \fancy{P}{ref}(a, u) \Land \varphi_1(a) \Land \fancy{S}{uff}(b, u) \Land \varphi_1(b).
\end{flalign*}
Където \me{\varphi_{2wordLetters}(u, a, b)} дефинира множеството:
\begin{gather*}
...
\begin{flalign*}
    ...
    & \start \start \indent \exists a \exists b (\varphi_{2wordLetters}(w_1, a, b) \Land  \fancy{S}{uff}(a, u_1) \Land \fancy{S}{uff}(b, v_1)))).
\end{flalign*}

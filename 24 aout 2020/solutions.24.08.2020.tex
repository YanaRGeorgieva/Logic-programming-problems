...
Това че $H$ е биекция се вижда лесно т.к. $H(H(w)) = Id_{\mathbb{A}^*}$. Сега тук нелогическите символи са само $f$ и за него ще се погрижим да проверим, че $H(f^S(u, v)) = f^S(H(u), H(v))$ за $u, v \in \mathbb{A}^*$. Т.к. $u, v \in \mathbb{A}^*$, то значи 
\begin{gather*}
